...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "u4mtfkpj8xi59me9"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//模式(可下发可上报)
//备注:
#define DPID_MODE 102
//亮度(可下发可上报)
//备注:
#define DPID_BRIGHT 103
//颜色(可下发可上报)
//备注:
#define DPID_COLOR 104
//效果(可下发可上报)
//备注:
#define DPID_EFFECT 105
//闪烁节奏(可下发可上报)
//备注:
#define DPID_FLASH 106
//图案(可下发可上报)
//备注:
#define DPID_ICON 107
//动画(可下发可上报)
//备注:
#define DPID_MONTION 108
